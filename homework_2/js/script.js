...
if (num1 <= 1) {
  console.log(`1-ое число меньше или равно 1`);
}
if (num2 >= 3) {
...
/* 
let test = true;
console.log(test === true ? "+++" : "---"); //тернарный оператор
*/
...
/* 
const day = +prompt("Введите целое число от 1 до 31");
if (day >= 1 && day < 11) {
...
/* 
const userNumber = +prompt("Введите положительное целое число");
const hundreds = Math.floor((userNumber % 1000) / 100);
const tens = Math.floor((userNumber % 100) / 10);
const units = Math.floor(userNumber % 10);
console.log(

...
// Всю вёрстку остальных частей реализовывать не нужно, если у вас она была
// сделана на html/css можно использовать, заново создавать не требуется.
...
productData.forEach(({ name, text, image, price }) => {
  const productEl = `
  <li class="products-list-item">
  <article>
    <div class="products-item-photo-wrp">
      <a href="#" class="item-photo-wrp-link">
        <img
          src="${image}"
    ...
    <div class="products-item-txt-wrp">
      <h3 class="products-item-title">${name}</h3>
      <p class="products-item-txt"> ${text}</p>
      <p class="products-item-price">$${price.toFixed(2)}</p>
      <button class="products-item-btn" type="button">
        <svg
          width="27"
          height="25"
          viewBox="0 0 27 25"
